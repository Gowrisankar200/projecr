			...
			<div class="col-md-5 col-md-offset-1">
				<div class="appointment-form">
					...
					<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" enctype="multipart/form-data">
                        ...
                        <input type="text" class="col-md-12 col-xs-12 appointment-name" name="rate" placeholder="Product Rate for 1 Kg" required  onkeypress='return event.charCode >= 48 && event.charCode <= 57'/>
